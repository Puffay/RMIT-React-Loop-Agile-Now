...
db.reply.belongsTo(db.user, { foreignKey: { name: "id", allowNull: false } });
db.reply.belongsTo(db.post, { foreignKey: { name: "post_id", allowNull: false } });
db.post.hasMany(db.reply, { foreignKey: { name: "post_id", allowNull: false } });
